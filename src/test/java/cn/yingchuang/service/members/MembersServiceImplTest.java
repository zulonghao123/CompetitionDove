...
public class MembersServiceImplTest {
    ...
    public void addMembers() throws Exception {
        ...
        Information information = new Information(0,"测试运动员1",1,"测试电话号","测试email","测试身份证","测试疾病","测试紧急联系人","测试紧急联系人电话",date,0);
        Integer rows = membersService.addMembers(new Members(0,"测试用户名1","测试密码","测试角色",information,"测试会员编号"));
        if(rows>0){
