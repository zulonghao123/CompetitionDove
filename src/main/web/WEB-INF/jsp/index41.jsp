    ...
    <div class="nav">
        <div class="wp">
            <ul>
                ...
                <li>
                    <a href="javascript:;" class="">赛鸽简介</a>
                ...
                <li>
                    <a href="http://www.dreamculture.cn/Show/index/pid/345.html" class="on">赛事</a>
                </li>
                <li>
    ...
    <div class="m-nv">
        <div class="wp">
            ...
            <ul>
                ...
                <li>
                    <a href="http://www.dreamculture.cn/News/col_show/pid/293/cid/296.html" class="on">管理阶层</a>
                </li>
                <li>
